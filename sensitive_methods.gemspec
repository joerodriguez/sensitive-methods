...
Gem::Specification.new do |s|
  ...
  s.files = ["README", "README.rdoc", "Rakefile", "lib/sensitive_methods.rb", "Manifest", "sensitive_methods.gemspec", "test/sensitive_methods_test.rb"]
  s.homepage = "http://github.com/joerodriguez/sensitive-methods"
  s.rdoc_options = ["--line-numbers", "--inline-source", "--title", "Sensitive_methods", "--main", "README.md"]
  s.require_paths = ["lib"]
  ...
  s.test_files = ["test/sensitive_methods_test.rb"]
